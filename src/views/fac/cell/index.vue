  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cellList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车间名称" align="center" prop="workshopId">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.fac_workshop_name" :value="scope.row.workshopId"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-table :data="facEndDeviceList" :row-class-name="rowFacEndDeviceIndex"
                  @selection-change="handleFacEndDeviceSelectionChange" ref="facEndDevice"
        >
